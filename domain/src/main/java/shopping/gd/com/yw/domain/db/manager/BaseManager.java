...
import shopping.gd.com.yw.domain.db.gen.DaoMaster;
import shopping.gd.com.yw.domain.db.gen.DaoSession;
import shopping.gd.com.yw.domain.db.service.IDatabase;
...
public abstract class BaseManager<M, K> implements IDatabase<M, K> {
    ...
    private static final String DEFAULT_DATABASE_NAME = "gdshop.db";
