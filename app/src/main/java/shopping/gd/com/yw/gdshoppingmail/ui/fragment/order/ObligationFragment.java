...
import shopping.gd.com.yw.gdshoppingmail.presenter.impl.ObligationOrderPresenterImpl;
...
public class ObligationFragment extends BaseAppFragment<ObligationOrderPresenterImpl> implements OrderContract.OBligationOrderView {
    ...
    @Override
    public void obligationOrderShow(List<Order> list) {
    ...
    public void onResume() {
        super.onResume();
        presenter.getObligationOrder();
    }

    @Override
    protected ObligationOrderPresenterImpl initPresenter() {
        return new ObligationOrderPresenterImpl();
    }
