...
import shopping.gd.com.yw.gdshoppingmail.presenter.impl.OwnFinishOrderPresenterImpl;
...
public class OwnFinishFragment extends BaseAppFragment<OwnFinishOrderPresenterImpl> implements OrderContract.OwnFinishOrderView {
    ...
    @Override
    public void OwnFinishOrderShow(List<Order> list) {
    ...
    @Override
    protected OwnFinishOrderPresenterImpl initPresenter() {
        return new OwnFinishOrderPresenterImpl();
    }

    @Override
    public void onResume() {
        super.onResume();
        presenter.getOwnFinishOrder();
    }
