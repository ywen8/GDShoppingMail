...
import shopping.gd.com.yw.gdshoppingmail.presenter.impl.ConsignOrderPresenterImpl;
...
public class ConsignmentFragment extends BaseAppFragment<ConsignOrderPresenterImpl> implements OrderContract.ConsignOrderView {
    ...
    @Override
    public void consignOrderShow(List<Order> list) {
    ...
    public void onResume() {
        super.onResume();
        presenter.getConsignOrder();
    }

    @Override
    protected ConsignOrderPresenterImpl initPresenter() {
        return new ConsignOrderPresenterImpl();
    }
